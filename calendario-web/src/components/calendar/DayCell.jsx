  ...
  return (
    <button
      ...
      className={[
        ...
        esMesActual ? 'bg-[var(--surface-900)]' : 'bg-[var(--surface-900)]/40',
        seleccionado
          ? 'bg-[var(--accent-500)]/10 ring-1 ring-inset ring-[var(--accent-500)]/40'
          : 'hover:bg-[var(--surface-800)]/60',
      ].join(' ')}
    >
      <span
        className={[
          'flex h-7 w-7 items-center justify-center rounded-full text-sm font-semibold',
          esHoy ? 'bg-[var(--accent-500)] text-white' : esMesActual ? 'text-slate-200' : 'text-slate-600',
        ].join(' ')}
      >
        {numeroDia}
      </span>
